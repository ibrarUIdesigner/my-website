        ...
        <section>
          ...
          <BentoCard className="p-6 mb-6">
            <p className="text-slate-300 text-sm leading-relaxed">
              ...
              outcome-first: optimize performance, reduce complexity, and
              deliver clean code that scales.
            </p>
            <p className="text-slate-400 text-sm leading-relaxed mt-4">
              On the backend, I integrate{" "}
              <span className="font-bold text-white">Node.js</span> and{" "}
              <span className="font-bold text-white">Express.js</span> with
              robust <span className="font-bold text-white">REST APIs</span>,
              designing interfaces that are predictable, secure, and simple to
              maintain.
            </p>
            <p className="text-slate-400 text-sm leading-relaxed mt-4">
              I also build{" "}
              <span className="font-bold text-white">workflow automation</span>{" "}
              with <span className="font-bold text-white">n8n</span>,{" "}
              <span className="font-bold text-white">Make.com</span>, and{" "}
              <span className="font-bold text-white">Zapier</span>, reducing
              manual ops, accelerating delivery, and connecting services through
              reliable API integration.
            </p>
            <p className="text-slate-400 text-sm leading-relaxed mt-4">
              Ownership mindset: I define technical direction, align trade‑offs
              with business goals, and deliver systems that stay maintainable in
              production — from component design and state management to CI/CD,
            ...
            <p className="text-slate-400 text-sm leading-relaxed mt-4">
              ...
              that consistently meet production standards.
            </p>
