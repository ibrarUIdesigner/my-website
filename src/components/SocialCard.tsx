...
export default function SocialCard(): JSX.Element {
  return (
    <BentoCard className="p-6 flex flex-col justify-center items-center gap-4">
      ...
      <a
        className="text-[10px] uppercase tracking-widest text-slate-500 hover:text-sky-400 transition-colors"
        href="mailto:ibrarUIdesigner@gmail.com"
      >
